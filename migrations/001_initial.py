...
def migrate(migrator, database, fake=False, **kwargs):
    ...
    class APITokenSettings(pw.Model):
        id = pw.AutoField()
        token = pw.ForeignKeyField(
            backref="apitokensettings_set",
            column_name="token_id",
            field="id",
            model=migrator.orm["api_token"],
        )
    ...
    class SubPostComment(pw.Model):
        ...
        parentcid = pw.ForeignKeyField(
            backref="subpostcomment_set",
            column_name="parentcid",
            field="cid",
            model="self",
            null=True,
        )
    ...
    class SubPostCommentReport(pw.Model):
        ...
        cid = pw.ForeignKeyField(
            backref="subpostcommentreport_set",
            column_name="cid",
            field="cid",
    ...
    class SubPostCommentVote(pw.Model):
        ...
        uid = pw.ForeignKeyField(
            backref="subpostcommentvote_set",
            column_name="uid",
            field="uid",
            model=migrator.orm["user"],
            null=True,
    ...
    class SubPostPollVote(pw.Model):
        ...
        vid = pw.ForeignKeyField(
            backref="votes",
            column_name="vid",
            field="id",
            model=migrator.orm["sub_post_poll_option"],
        )
